...
public class DataFormat {
    public static String baseURL = "/home/hadoop/experiment/dataSet"; //Project BaseURL
    public static String rulesFirstOrder = "/rules-first-order.txt";
    ...
    public static String groundFile = "HAI-HOSP-hasID.csv";
